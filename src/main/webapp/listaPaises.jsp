                ...
                <div class="w-75">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="<%=request.getContextPath()%>?action=editar"><span class="fa fa-edit"></span></a></td>
                            <td><a class="btn btn-danger" href="<%=request.getContextPath()%>?action=borrar"><span class="fa fa-trash"></span></a></td>
                        </tr>
                        <%
                            }
                        %>
